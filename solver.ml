...
external create : Options.t -> t = "ocaml_bitwuzla_new"

external unsafe_delete : t -> unit = "ocaml_bitwuzla_delete"

external configure_terminator : t -> (unit -> bool) option -> unit
  = "ocaml_bitwuzla_configure_terminator"

external push : t -> (int[@untagged]) -> unit
  = "ocaml_bitwuzla_push" "native_bitwuzla_push"

external pop : t -> (int[@untagged]) -> unit
  = "ocaml_bitwuzla_pop" "native_bitwuzla_pop"

external assert_formula : t -> Term.t -> unit = "ocaml_bitwuzla_assert_formula"

external get_assertions : t -> Term.t array = "ocaml_bitwuzla_get_assertions"

external pp_formula : Format.formatter -> t -> unit
  = "ocaml_bitwuzla_pp_formula"

external pp_statistics : Format.formatter -> t -> unit
  = "ocaml_bitwuzla_pp_statistics"
...
external get_unsat_core : t -> Term.t array = "ocaml_bitwuzla_get_unsat_core"

external simplify : t -> unit = "ocaml_bitwuzla_simplify"
...
external get_value : t -> Term.t -> Term.t = "ocaml_bitwuzla_get_value"
