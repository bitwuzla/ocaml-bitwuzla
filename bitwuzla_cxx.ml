...
external copyright : unit -> string = "ocaml_bitwuzla_copyright"

external version : unit -> string = "ocaml_bitwuzla_version"

external init_format : unit -> unit = "ocaml_bitwuzla_init_format"
...
external mk_bool_sort : unit -> Sort.t = "ocaml_bitwuzla_mk_bool_sort"

external mk_bv_sort : (int[@untagged]) -> Sort.t
  = "ocaml_bitwuzla_mk_bv_sort" "native_bitwuzla_mk_bv_sort"

external mk_fp_sort : (int[@untagged]) -> (int[@untagged]) -> Sort.t
  = "ocaml_bitwuzla_mk_fp_sort" "native_bitwuzla_mk_fp_sort"

external mk_fun_sort : Sort.t array -> Sort.t -> Sort.t
  = "ocaml_bitwuzla_mk_fun_sort"

external mk_rm_sort : unit -> Sort.t = "ocaml_bitwuzla_mk_rm_sort"

external mk_uninterpreted_sort : ?symbol:string -> unit -> Sort.t
  = "ocaml_bitwuzla_mk_uninterpreted_sort"

module RoundingMode = RoundingMode
module Kind = Kind
module Term = Term

external mk_true : unit -> Term.t = "ocaml_bitwuzla_mk_true"

external mk_false : unit -> Term.t = "ocaml_bitwuzla_mk_false"

external mk_bv_zero : Sort.t -> Term.t = "ocaml_bitwuzla_mk_bv_zero"

external mk_bv_one : Sort.t -> Term.t = "ocaml_bitwuzla_mk_bv_one"

external mk_bv_ones : Sort.t -> Term.t = "ocaml_bitwuzla_mk_bv_ones"

external mk_bv_min_signed : Sort.t -> Term.t = "ocaml_bitwuzla_mk_bv_min_signed"

external mk_bv_max_signed : Sort.t -> Term.t = "ocaml_bitwuzla_mk_bv_max_signed"
...
external mk_bv_value_int : Sort.t -> (int[@untagged]) -> Term.t
  = "ocaml_bitwuzla_mk_bv_value_int" "native_bitwuzla_mk_bv_value_int64"

external mk_bv_value_int64 : Sort.t -> (int64[@unboxed]) -> Term.t
  = "ocaml_bitwuzla_mk_bv_value_int64" "native_bitwuzla_mk_bv_value_int64"

external mk_fp_pos_zero : Sort.t -> Term.t = "ocaml_bitwuzla_mk_fp_pos_zero"

external mk_fp_neg_zero : Sort.t -> Term.t = "ocaml_bitwuzla_mk_fp_neg_zero"

external mk_fp_pos_inf : Sort.t -> Term.t = "ocaml_bitwuzla_mk_fp_pos_inf"

external mk_fp_neg_inf : Sort.t -> Term.t = "ocaml_bitwuzla_mk_fp_neg_inf"

external mk_fp_nan : Sort.t -> Term.t = "ocaml_bitwuzla_mk_fp_nan"
...
external mk_term2_indexed2 :
  ...
  (int[@untagged]) ->
  Term.t
  = "ocaml_bitwuzla_mk_term2_indexed2" "native_bitwuzla_mk_term2_indexed2"
...
external mk_var : ?symbol:string -> Sort.t -> Term.t = "ocaml_bitwuzla_mk_var"
